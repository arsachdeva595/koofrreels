...
"""
    ...
    system = (
        ...
        "- speaking_on_camera is ALWAYS false — this is documentary/narration style: the voiceover\n"
        "  carries ALL narration, the character is NEVER shown speaking. Frame every shot as\n"
        "  listening, breathing, observing, acting, or reacting silently — never talking to camera\n"
        "  or to another character. There is no lip-sync, so any shot that reads as mid-speech will\n"
        "  look broken against the voiceover.\n"
